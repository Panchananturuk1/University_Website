<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyMnager.aspx.cs" Inherits="MyMnager" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mycon %>" SelectCommand="SELECT * FROM [monu]"></asp:SqlDataSource>
