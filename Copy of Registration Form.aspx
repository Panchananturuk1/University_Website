<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of Registration Form.aspx.cs" Inherits="Default4" %>
...
<body style="background: url(wlp.jpg)">
    ...
    <p style="margin-top: 40px; color:#09ef7c" class="auto-style2" > Registration Page</p>

    <table class="auto-style1">
        <tr>
            <td class="auto-style7">Full Name</td>
            <td class="auto-style8">
                <asp:TextBox ID="Fullanme" runat="server" Height="21px" Width="235px" placeholder="Enter Fullname" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Yor Name" ControlToValidate="Fullanme" CssClass="auto-style6"></asp:RequiredFieldValidator>
            </td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="DOB" runat="server" Height="21px" Width="235px" placeholder="Enter Date of Birth"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Enter Your Date of birth" ControlToValidate="DOB" CssClass="auto-style6"></asp:RequiredFieldValidator>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="country" runat="server" Height="21px" Width="235px" style="margin-left: 30px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="select country" ControlToValidate="country" CssClass="auto-style6" InitialValue="--Select--"></asp:RequiredFieldValidator>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="MobileNo" runat="server" Height="21px" Width="235px" placeholder="Enter Mobile Number"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Enter your mobile number" ControlToValidate="MobileNo" CssClass="auto-style6"></asp:RequiredFieldValidator>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="Gender" runat="server" Height="21px" Width="235px" style="margin-left: 30px">
                    <asp:ListItem>--Select--</asp:ListItem>
                    <asp:ListItem>MALE</asp:ListItem>
                    <asp:ListItem>FEMALE</asp:ListItem>
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="select gender" ControlToValidate="Gender" CssClass="auto-style6" InitialValue="--Select--"></asp:RequiredFieldValidator>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
