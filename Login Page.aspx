<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="Login Page.aspx.cs" Inherits="Login_related_details.Login" %>
        ...
        <div id="fixedheader"> 
          ...
          <table class="auto-style18">
	       ...
	       <li><a href="index.aspx">HOME</a>
            ...
            <asp:Label ID="lb1" runat="server" style="text-align: center"></asp:Label>
    ...
    <div class="loginBox">
        ...
        <h2 class="auto-style1" style="text-align:center">Log In Here</h2>
            <form id="Form1" runat="server">
                <p class="auto-style2">User Name</p>
                <asp:TextBox ID="TextBox1" runat="server" ForeColor="White" placeholder="Enter Email"></asp:TextBox>
...
&nbsp;<p class="auto-style2">Password</p>
            ...
            BackColor="#CCFF99"   OnClientClick="Validate()" onclick="Button1_Click" Height="40px" />
                    ...
                    <tr>
                        ...
                        <td style=" width: 270px;"  class="auto-style45"><span style="color: #FFFFFF;"><h8><strong>GENERAL</strong></h8></span>
                         ...
                         <td style=" width: 270px;"><span style="color: #FFFFFF;"><h8><strong>ADMISSION</strong></h8></span>
                            <ul style="list-style-type:none; height:100px;">
                                ...
                                <li class="auto-style46"><a href="CUO Media/fecualty profile for website.pdf" class="auto-style70"><span class="auto-style45">Faculty Details</span></a></li>
                            </ul>
                        ...
                        <td style=" width: 270px;"><span style="color: #FFFFFF;"><h8><strong>IMPORTANT LINKS</strong></h8></span>
                            <ul style="list-style-type:none; height:100px;">
                              ...
                              <a href="https://www.facebook.com/"> <asp:Image ID="Image23"   runat="server" Height="60px" ImageUrl="~/Logo/FB.png" /></a>
          <a href="https://twitter.com/login"><asp:Image ID="Image24" runat="server" Height="60px" ImageUrl="~/Logo/Twt.png" /></a>
              <a href="https://www.instagram.com/?hl=en"><asp:Image ID="Image25" runat="server" Height="60px" ImageUrl="~/Logo/Insta.png" /></a>
